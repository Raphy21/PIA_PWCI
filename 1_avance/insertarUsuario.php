...
if (isset($_POST['usuario']) && isset($_POST['correo']) && isset($_POST['contrasena'])) {
    ...
    $consulta = "SELECT * FROM registroUsuario WHERE usuario = '$nombreUsuario' OR correo = '$correo'";
    ...
    if ($resultado->num_rows > 0) {
        ...
        $sql = "INSERT INTO registroUsuario (usuario, correo, pass) VALUES ('$nombreUsuario', '$correo', '$contrasena')";
