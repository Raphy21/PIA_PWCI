...
function obtenerVentas(event) {
    ...
    $.ajax({
        type: "POST",
        url: "API/api.php/api/listas/ventas",
  ...
  function renderLista(datos) {
    ...
    let encabezados = ['FechaHoraFin', 'Precio', 'NombreProducto', 'Calificacion', 'NombreCategoria', 'Existencia'];
